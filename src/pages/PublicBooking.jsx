      ...
      case 3: {
        ...
        return (
          <div className="fade-in">
            ...
            <button className="btn-secondary" style={{ marginTop: '1.25rem' }} onClick={() => setStep(2)}>
              Voltar
            </button>
          </div>
        );
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          color: '#111827',
                          fontWeight: 700,
                          opacity: googleBusy ? 0.8 : 1
                        }}
                      >
                        {googleBusy ? 'Conectando Google...' : 'Entrar com Google'}
                      </button>
                    </>
                  )}
                </form>
